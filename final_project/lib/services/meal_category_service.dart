...
class MealCategoryService {
  static List<MealCategory> getMealCategories() {
    // Embedding the JSON data directly into the service
...
''';
    ...
    final List<dynamic> categoriesData = json.decode(jsonData)['categories'];

    return categoriesData
        .map((categoryData) => MealCategory(
              idCategory: categoryData['idCategory'],
              strCategory: categoryData['strCategory'],
              strCategoryThumb: categoryData['strCategoryThumb'],
              strCategoryDescription: categoryData['strCategoryDescription'],
            ))
        .toList();
  }
}
